          ...
          <div class="col-sm-6 col-xl-3">
            <div class="overflow-hidden card rounded-2">
              <div class="position-relative">
                ...
                <a href="javascript:void(0)" class="bottom-0 p-2 text-white bg-primary rounded-circle d-inline-flex position-absolute end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i class="ti ti-basket fs-4"></i></a>                      </div>
              <div class="p-4 pt-3 card-body">
                <h6 class="fw-semibold fs-4">Boat Headphone</h6>
                <div class="d-flex align-items-center justify-content-between">
                  <h6 class="mb-0 fw-semibold fs-4">$50 <span class="ms-2 fw-normal text-muted fs-3"><del>$65</del></span></h6>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="overflow-hidden card rounded-2">
              ...
              <div class="p-4 pt-3 card-body">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <h6 class="mb-0 fw-semibold fs-4">$650 <span class="ms-2 fw-normal text-muted fs-3"><del>$900</del></span></h6>
                  <ul class="mb-0 list-unstyled d-flex align-items-center">
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="overflow-hidden card rounded-2">
              ...
              <div class="p-4 pt-3 card-body">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <h6 class="mb-0 fw-semibold fs-4">$150 <span class="ms-2 fw-normal text-muted fs-3"><del>$200</del></span></h6>
                  <ul class="mb-0 list-unstyled d-flex align-items-center">
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="overflow-hidden card rounded-2">
              ...
              <div class="p-4 pt-3 card-body">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <h6 class="mb-0 fw-semibold fs-4">$285 <span class="ms-2 fw-normal text-muted fs-3"><del>$345</del></span></h6>
                  <ul class="mb-0 list-unstyled d-flex align-items-center">
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
                    <li><a class="me-1" href="javascript:void(0)"><i class="ti ti-star text-warning"></i></a></li>
