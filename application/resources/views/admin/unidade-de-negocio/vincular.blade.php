                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.grupo-de-negocios.store') }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label id="observacaoLabel" class="form-label"></label>
                                        <textarea class="form-control @error('unidade_negocio') is-invalid @enderror" id="observacaoInput"
                                            name="unidade_negocio" placeholder="Unidade de Negócio">{{ old('unidade_negocio') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        <label id="observacaoLabel" class="form-label">Un</label>
                                        <textarea class="form-control @error('licenca') is-invalid @enderror" id="observacaoInput" name="observacao"
                                            placeholder="Licença">{{ old('licenca') }}</textarea>
                                        @error('licenca')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
