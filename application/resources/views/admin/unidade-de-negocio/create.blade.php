                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.unidade-de-negocio.store') }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3" id="cpfInputDiv"
                                        @if (old('tipoPessoaInput') == 'pf') style="display: block;" @else style="display: none;" @endif>
                                    ...
                                    <div class="mb-3" id="cnpjInputDiv"
                                        @if (old('tipoPessoaInput') == 'pj') style="display: block;" @else style="display: none;" @endif>
