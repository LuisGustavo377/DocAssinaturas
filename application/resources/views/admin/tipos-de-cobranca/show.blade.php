...
@section('title', 'Detalhar Tipo de Cobrança')
                                ...
                                <div class="row">
                                    <div class="mb-12 col-md-12">
                                        ...
                                        <input type="text" class="form-control @error('descricao') is-invalid @enderror"
                                            id="nomeInput" name="nome" value="{{ $tipo_de_cobranca->descricao }}" disabled>
                                    </div>
                    ...
                    <div class="mb-3 d-flex justify-content-end">
                        <div class="mb-3">
                            <div class="my-4 text-center">
                                ...
                                <a href="{{ url('admin/tipo-de-cobranca/' . $tipo_de_cobranca->id . '/edit') }}" class="btn btn-success me-2">
