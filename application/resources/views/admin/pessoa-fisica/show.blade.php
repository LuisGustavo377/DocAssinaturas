...
@section('title', 'Detalhar Pessoa Física')
...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">@yield('title'): {{$pessoa->nome}}</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card-body">
                        ...
                        <img src="{{ asset($pessoa->imagem_path) }}" class="img-fluid" alt="Imagem">
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('numero') is-invalid @enderror" id="numeroInput"
                        name="numero" placeholder="Número" value="{{ $pessoa->numero }}" disabled>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bairro') is-invalid @enderror" id="bairroInput"
                        name="bairro" placeholder="Bairro" value="{{ $pessoa->bairro}}" disabled>
                </div>
