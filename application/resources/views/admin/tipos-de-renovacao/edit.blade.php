...
@section('title', 'Alterar Tipo de Renovação')
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.tipos-de-renovacao.update', $tipo_de_renovacao->id) }}">
                                    ...
                                    <div class="row">
                                        <div class="mb-12 col-md-12">
                                            ...
                                            <input type="text" class="form-control @error('nome') is-invalid @enderror"
                                                id="descricaoInput" name="descricao" value="{{ $tipo_de_renovacao->descricao }}">
                                            @error('descricao')
