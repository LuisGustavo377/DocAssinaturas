                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <select
                                                class="form-select @error('tipo_de_logradouro_id') is-invalid @enderror"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select class="form-select select2 @error('estado_id') is-invalid @enderror"
                                                ...
                                                <option value="" selected disabled> -- Selecione o estado --
                                                </option>
                                                @foreach ($estados->sortBy('nome') as $estado)
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select class="form-select select2 @error('cidade_id') is-invalid @enderror"
                                                ...
                                                <option value="" selected disabled> -- Selecione a cidade --
                                                </option>
                                                @foreach ($cidades->sortBy('nome') as $cidade)
